...
public class SearchEmptyScenario extends TestScenario{
    ...
    private static String SEARCH_MESSAGE = "Please provide a search word.";
    ...
    public void searchValueValidations() throws IOException {
        try{
            ...
            Assert.assertEquals(SEARCH_MESSAGE,SearchActions.searchValueAndValidateMenssage(""));
